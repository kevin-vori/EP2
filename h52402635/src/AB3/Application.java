...
public class Application {
    public static void main(String[] args) {
        ...
        BrailleEncoder be = new BrailleEncoder();
        BrailleSymbolTree st = new BrailleSymbolTree(new BrailleEncoder());
//
//        for (int i = 'a'; i < 'z'; i++) {
//            System.out.println(st.getNode(be.toBinary((char) i)).getSymbol());
//        }
        BrailleDecoder BD = new BrailleDecoder(be);

        for (int i = 'a'; i <= 'z'; i++) {
            System.out.println(BD.decodeBitmap(font.getBitmap((char) i),'o'));
